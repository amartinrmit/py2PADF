...
void correlation_rtheta( settings * s, double * polar, double * polar2, double * corr ){
...
void correlation_rtheta_faster( settings * s, double * polar, double * polar2, double * corr ){
